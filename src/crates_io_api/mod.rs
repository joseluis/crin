...
//mod async_client; // TEMPORARY_VENDOR
mod sync_client;
mod types;

//pub use crate::async_client::Client as AsyncClient;
// pub use crate::sync_client::SyncClient;
pub use self::sync_client::SyncClient;  // TEMPORARY_VENDOR
//pub use crate::types::*;  // TEMPORARY_VENDOR
pub use self::types::*; // TEMPORARY_VENDOR
